...
``;
export async function textPrint(message) {
  clear();
...
export async function boot() {
  ...
  await type("Welcome to Lawrence's portfolio terminal", {
    initialWait: 500,
  });

  await type(["> SET TERMINAL/BOOT", "Loading portfolio AI............"], {
    lineWait: 500,
  });
  await type(
    [
...
export async function login() {
  ...
  await fetch("/api/auth", {
    ...
    .then((res) => {
      authorized = res.authorized.auth;
